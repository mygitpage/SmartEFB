...
public class ConstansClassOurArrangement {
    ...
    public static final String namePrefsShowArrangementComment = "showArrangementComment";

    // prefs name for show old arrangement
    public static final String namePrefsShowOldArrangement = "showOldArrangements";
    ...
    // prefs name for start Date Evaluation in mills
    public static final String namePrefsEndDateEvaluationInMills = "endDataEvaluationInMills";
    ...
    public static final String namePrefsCommentDelaytime = "commentOurArrangementDelaytime";
    ...
    public static final String namePrefsSketchCommentDelaytime = "commentSketchOurArrangementDelaytime";
