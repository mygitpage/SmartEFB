...
/**
 * Created by ich on 12.07.16.
 */
public class OurArrangementCommentHistoryCursorAdapter extends CursorAdapter {
    ...
    // Default constructor
    public OurArrangementCommentHistoryCursorAdapter (Context context, Cursor cursor, int flags) {
