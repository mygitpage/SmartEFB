...
class ConstansClassSettings {
    ...
    static final String urlFirstConnectToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=establish";

    // URL connection established ok
    static final String urlConnectionEstablishedToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=establishedok";

    // URL connection ask for new data
    static final String urlConnectionAskForNewDataToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=asknewdata";

    // URL connection send comment now arrangement to server
    static final String urlConnectionSendNewCommentArrangementToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendarrangementcomment";

    // URL connection send comment sketch arrangement to server
    static final String urlConnectionSendNewSketchCommentArrangementToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendsketcharrangementcomment";

    // URL connection send evaluation result arrangement to server
    static final String urlConnectionSendEvaluationResultArrangementToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendevaluationresultarrangement";

    // URL connection send comment jointly goals to server
    static final String urlConnectionSendNewCommentJointlyGoalsToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendjointlygoalscomment";

    // URL connection send evaluation result jointly goals to server
    static final String urlConnectionSendEvaluationResultJointlyGoalsToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendevaluationresultgoals";

    // URL connection send comment debetable goals to server
    static final String urlConnectionSendNewCommentDebetableGoalsToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=senddebetablegoalscomment";

    // URL connection send connect book message to server
    static final String urlConnectionSendConnectBookMessageToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendconnectbookmessage";

    // URL connection send meeting data to server
    static final String urlConnectionSendMeetingDataToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendmeetingdata";

    // URL connection send message data to server (associated and not associated)
    static final String urlConnectionSendMessageToServer = "http://www.smart-efb.de/index.php?com=exchange&subcom=sendmessage";
