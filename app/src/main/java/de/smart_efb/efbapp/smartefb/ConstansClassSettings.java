...
public class ConstansClassSettings {
    ...
    //public static final String urlConnectionSendNewSketchCommentArrangementToServer = "http://192.168.178.25/index.php?com=exchange&subcom=sendsketcharrangementcomment";
    ...
    //public static final String urlConnectionSendEvaluationResultArrangementToServer = "http://192.168.178.25/index.php?com=exchange&subcom=sendevaluationresultarrangement";
    ...
    //public static final String urlConnectionSendNewCommentJointlyGoalsToServer = "http://192.168.178.25/index.php?com=exchange&subcom=sendjointlygoalscomment";
    ...
    //public static final String urlConnectionSendEvaluationResultJointlyGoalsToServer = "http://192.168.178.25/index.php?com=exchange&subcom=sendevaluationresultgoals";
    ...
    //public static final String urlConnectionSendNewCommentDebetableGoalsToServer = "http://192.168.178.25/index.php?com=exchange&subcom=senddebetablegoalscomment";
    ...
    //public static final String urlConnectionSendConnectBookMessageToServer = "http://192.168.178.25/index.php?com=exchange&subcom=sendconnectbookmessage";
