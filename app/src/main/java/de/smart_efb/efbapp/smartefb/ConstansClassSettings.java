...
public class ConstansClassSettings {
    ...
    //public static final String urlFirstConnectToServer = "http://192.168.178.24/index.php?com=exchange&subcom=establish";
    ...
    //public static final String urlConnectionEstablishedToServer = "http://192.168.178.24/index.php?com=exchange&subcom=establishedok";
    ...
    //public static final String urlConnectionAskForNewDataToServer = "http://192.168.178.24/index.php?com=exchange&subcom=asknewdata";
    ...
    //public static final String urlConnectionSendNewCommentArrangementToServer = "http://192.168.178.24/index.php?com=exchange&subcom=sendarrangementcomment";
    ...
    //public static final String urlConnectionSendEvaluationResultArrangementToServer = "http://192.168.178.24/index.php?com=exchange&subcom=sendevaluationresultarrangement";
