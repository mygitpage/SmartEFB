...
class ConstansClassSettings {
    ...
    static final String urlConnectionSendAskForTimeToServer = "http://192.168.0.126/index.php?com=exchange&subcom=asktime";
    ...
    static final String urlConnectionSendMessageToServer = "http://192.168.0.126/index.php?com=exchange&subcom=sendmessage";
