 ...
 */
public class ConstansClassOurGoals {
    ...
    public static final String namePrefsCurrentDateOfDebetableGoals = "currentDateOfDebetableGoals";
    ...
    public static final String namePrefsShowLinkCommentJointlyGoals = "showCommentLinkJointlyGoals";

    // prefs name for show link for old goals
    public static final String namePrefsShowLinkOldGoals = "showOldGoals";


    // prefs name for show link for debetable goals
    public static final String namePrefsShowLinkDebetableGoals = "showDebetableGoals";

    // prefs name for show link for comment debetable goals
    public static final String namePrefsShowLinkCommentDebetableGoals = "showCommentLinkDebetableGoals";
    ...
    // prefs name for start Date Evaluation in mills
    public static final String namePrefsEndDateJointlyGoalsEvaluationInMills = "endDataJointlyGoalsEvaluationInMills";

    // prefs name for evaluation jointly goal pause time in seconds
    public static final String namePrefsEvaluateJointlyGoalsPauseTimeInSeconds = "evaluateJointlyGoalsPauseTimeInSeconds";
