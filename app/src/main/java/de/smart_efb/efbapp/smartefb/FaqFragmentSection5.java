...
public class FaqFragmentSection5 extends Fragment {
    ...
    // fragment context
    Context fragmentFaqSectionFiveContext = null;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        getActivity().getApplicationContext().registerReceiver(faqFragmentSection5BrodcastReceiver, filter);
    ...
    public void onViewCreated(View view, @Nullable Bundle saveInstanceState) {
        ...
        if (!prefs.getBoolean(ConstansClassSettings.namePrefsCaseClose, false)) {
            ...
            Intent startServiceIntent = new Intent(fragmentFaqSectionFiveContext, ExchangeJobIntentServiceEfb.class);
            // set command = "ask new data" on server
            startServiceIntent.putExtra("com", "ask_new_data");
            startServiceIntent.putExtra("dbid",0L);
            startServiceIntent.putExtra("receiverBroadcast","");
            // start service
            ExchangeJobIntentServiceEfb.enqueueWork(fragmentFaqSectionFiveContext, startServiceIntent);
        }
    ...
    public void onDestroyView() {
        ...
        getActivity().getApplicationContext().unregisterReceiver(faqFragmentSection5BrodcastReceiver);
    }


    private final BroadcastReceiver faqFragmentSection5BrodcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intentExtras != null) {
                ...
                if (tmpSettings != null && tmpSettings.equals("1") && tmpCaseClose != null && tmpCaseClose.equals("1")) {
                    ...
                    String textCaseClose = fragmentFaqSectionFiveContext.getString(R.string.toastCaseClose);
