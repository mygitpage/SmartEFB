...
public class OurGoalsViewPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public OurGoalsViewPagerAdapter(FragmentManager ourGoalsFragmentMana, Context context) {
        ...
        fragJointlyGoalsOld = new OurGoalsFragmentJointlyOld();
        ...
        fragDebetableGoalsNow = new OurGoalsFragmentDebetableGoalsNow();
        fragDebetableGoalsComment = new OurGoalsFragmentDebetableGoalsComment();
        fragDebetableGoalsShowComment = new OurGoalsFragmentShowDebetableGoalComment();
